...
export default function GimsocMemberOnlineTicket() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Add ticket type
      formDataToSend.append('ticketType', 'GIMSOC Member Online')
      formDataToSend.append('ticketCategory', 'Online')
      formDataToSend.append('memberType', 'GIMSOC')
      formDataToSend.append('price', '14 USD / 30 GEL / 1000 INR')
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for registering for MEDCON'25 Online (GIMSOC Member). 
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-8 text-white relative overflow-hidden">
            ...
            <div className="relative">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold mb-2">GIMSOC Member Online Ticket</h1>
                  <p className="text-white text-opacity-90 text-sm">14 USD / 30 GEL / 1000 INR</p>
                </div>
              </div>
              
              <div className="bg-white bg-opacity-20 p-4 rounded-lg backdrop-blur-sm">
                <p className="text-sm">
                  You are registering as a GIMSOC Member. This ticket grants you online access to speaker sessions and poster/oral presentations only. Booths and Gala Night are not included.
                </p>
              </div>
            </div>
          </div>
