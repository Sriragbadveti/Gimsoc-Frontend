...
// import { Upload, User, GraduationCap, Camera, Utensils, CreditCard, AlertCircle, CheckCircle } from "lucide-react"
// import axios from "axios"

// export default function TsuTicket() {
...
//             <h1 className="text-3xl font-bold text-white text-center">TSU Student Registration</h1>
//             <p className="text-blue-100 text-center mt-2">Discounted registration for TSU medical students</p>
...
//                       <span className="text-2xl font-bold text-blue-600">45 GEL</span>
//                     </div>
//                     <p className="text-sm text-gray-600 mt-1">TSU student ticket</p>
//                   </div>
...
//                               </p>
//                               <p>
//                                 <span className="font-medium">Name of Beneficiary:</span> Mandrika Santosh Umanga
//                                 Fernando
//                               </p>
//                             </div>
//                           </div>
...
//                     }`}
//                   >
//                     {isSubmitting ? "Submitting..." : "Submit TSU Student Registration"}
//                   </button>
//                 </div>
//               </>
//             )}
