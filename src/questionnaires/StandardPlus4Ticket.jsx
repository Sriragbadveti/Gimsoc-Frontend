...
const BalloonAnimation = ({ onComplete }) => {
  const balloons = [
    { id: 1, color: 'bg-red-500', delay: 0, x: '10%' },
    { id: 2, color: 'bg-blue-500', delay: 0.2, x: '20%' },
    { id: 3, color: 'bg-green-500', delay: 0.4, x: '30%' },
    { id: 4, color: 'bg-yellow-500', delay: 0.6, x: '40%' },
    { id: 5, color: 'bg-purple-500', delay: 0.8, x: '50%' },
    { id: 6, color: 'bg-pink-500', delay: 1.0, x: '60%' },
    { id: 7, color: 'bg-indigo-500', delay: 1.2, x: '70%' },
    { id: 8, color: 'bg-orange-500', delay: 1.4, x: '80%' },
    { id: 9, color: 'bg-teal-500', delay: 1.6, x: '90%' },
    { id: 10, color: 'bg-rose-500', delay: 1.8, x: '95%' },
  ]
      ...
      <div className="text-center">
        ...
        <div className="relative h-96 w-full overflow-hidden">
          {balloons.map((balloon) => (
            <div
              key={balloon.id}
              className={`absolute ${balloon.color} w-8 h-10 rounded-full balloon-float`}
              style={{
                left: balloon.x,
                bottom: '-40px',
