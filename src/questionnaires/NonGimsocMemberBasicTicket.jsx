...
export default function NonGimsocMemberBasicTicket() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Object.keys(formData).forEach(key => {
        ...
        } else if (key === "declarationAccurate" || key === "policyCompliance") {
      ...
      // Add ticket type
      formDataToSend.append('ticketType', 'Non-GIMSOC Member Basic')
      formDataToSend.append('ticketCategory', 'Basic')
      formDataToSend.append('memberType', 'Non-GIMSOC')
      formDataToSend.append('price', '40 GEL / 1320 INR')
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for registering for MEDCON'25 Basic (Non-GIMSOC Member). 
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-8 text-white relative overflow-hidden">
            ...
            <div className="relative">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold mb-2">Non-GIMSOC Member Basic Ticket</h1>
                  <p className="text-white text-opacity-90 text-sm">40 GEL / 1320 INR</p>
                </div>
              </div>
