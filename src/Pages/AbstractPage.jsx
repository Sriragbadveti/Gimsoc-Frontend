...
import { Upload, FileText, User, Award, AlertCircle } from "lucide-react"
  ...
  try {
    ...
    const response = await axios.post(
      ...
      form,
      {
        ...
        withCredentials: true, // ✅ Send cookies along (important if auth required)
      }
    )
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-700">
                    I understand that if my ticket is not verified or the file is inaccessible, my abstract will be
