...
const navigation = [
  ...
  { name: "Register for MEDCON", href: "/tickets" },
  {
    ...
    href: "#",
    subItems: [
      { name: "Medcon 2024", href: "/medcon2024", description: "Previous year highlights" },
      { name: "Medcon 2023", href: "/medcon2023", description: "Past conference details" },
      { name: "Details About Us", href: "/about-details", description: "Our mission and vision" },
    ],
  },
                  ...
                  {navigation.map((item) =>
                    item.subItems ? (
                      <div key={item.name} className="space-y-1">
                        <span className="block px-3 py-2 text-base/7 font-semibold text-gray-900">{item.name}</span>
